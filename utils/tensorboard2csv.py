...
def main(logdir_or_logfile: str, write_pkl: bool, write_csv: bool, out_dir: str, sd: int):
    ...
    if event_paths:
        ...
        if write_csv:
            ...
            out_file = os.path.join(out_dir, "all_training_logs_in_one_file_sd_{}.csv".format(sd))
            print(out_file)
...
if __name__ == "__main__":
    res_dir = '../../../../../ExpDataDARPA/rl4wound_paper_res/non_ctr/data_map524/'

    for pp in range(3):
        for ss in range(5):
            seed = pp * 5 + ss
            log_dir = '../../../../../ExpDataDARPA/rl4wound_paper_res/non_ctr/runs_map524/' #Tue_Oct_24_08_47_04_2023_alg_map524_sd_{}'.format(seed)
            for dir_tmp in os.listdir(log_dir):
                if dir_tmp.endswith('sd_{}'.format(seed)):
                    log_dir_tmp = log_dir + dir_tmp
                    main(logdir_or_logfile=log_dir_tmp, write_pkl=False, write_csv=True, out_dir=res_dir, sd=seed)