...
dataFrame.to_csv('~/Desktop/Close_Loop_Actuation/Wound_3.csv', index=False)
...
u_app_ch7[0]= aaa_ch7
u_app_ch8[0] = aaa_ch8
df = pd.read_csv('~/Desktop/Close_Loop_Actuation/Output/Wound_3.csv')
...
for i in range(1,Nnc):
    ...
    print(dataFrame)
    dataFrame = pd.DataFrame(csv_table)
    dataFrame.to_csv('~/Desktop/Close_Loop_Actuation/Wound_3.csv', mode='a', index=False, header=False)
